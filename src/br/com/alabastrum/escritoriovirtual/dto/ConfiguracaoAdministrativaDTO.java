...
public class ConfiguracaoAdministrativaDTO {
    ...
    private String valorMinimoPedidoAdesao;
    private String valorMaximoPedidoAdesao;
    private String valorMinimoPedidoAtividade;
    private String valorMaximoPedidoAtividade;
    ...
    public String getValorMinimoPedidoAdesao() {
	return valorMinimoPedidoAdesao;
    }

    public void setValorMinimoPedidoAdesao(String valorMinimoPedidoAdesao) {
	this.valorMinimoPedidoAdesao = valorMinimoPedidoAdesao;
    }

    public String getValorMaximoPedidoAdesao() {
	return valorMaximoPedidoAdesao;
    }

    public void setValorMaximoPedidoAdesao(String valorMaximoPedidoAdesao) {
	this.valorMaximoPedidoAdesao = valorMaximoPedidoAdesao;
    }

    public String getValorMinimoPedidoAtividade() {
	return valorMinimoPedidoAtividade;
    }

    public void setValorMinimoPedidoAtividade(String valorMinimoPedidoAtividade) {
	this.valorMinimoPedidoAtividade = valorMinimoPedidoAtividade;
    }

    public String getValorMaximoPedidoAtividade() {
	return valorMaximoPedidoAtividade;
    }

    public void setValorMaximoPedidoAtividade(String valorMaximoPedidoAtividade) {
	this.valorMaximoPedidoAtividade = valorMaximoPedidoAtividade;
    }
