...
public class SaldoDTO {
    ...
    public SaldoDTO(BigDecimal saldoPrevistoNoMes, BigDecimal saldoPrevistoTotal, BigDecimal saldoLiberado, BigDecimal ganhosAteHoje, BigDecimal inss, List<ExtratoDTO> extratoDoMes) {
